...
class SymmetricOrderingGenerator(object):
    ...
    symmetry : str, default 'spherical'
        ...
        'reflective_planar' = reflective planar symmetry around both
        ...
        'reflective_circular' = reflective ring symmetry around both
    ...
    cutoff: float, default 1.0
        ...
        between two neighbor shells. If symmetry='chemical' or 
        symmetry='conventional', this is the cutoff radius (in Angstrom) 
        for CNA and will automatically use a reasonable cutoff based on 
        the lattice constant of the material if cutoff < 1. If the 
        structure is distorted, please use a larger cutoff. 
    ...
    secondary_symmetry : str, default None
        ...
        'cylindrical', 'planar', 'reflective_planar', 'chemical' and
    ...
    def __init__(self, atoms, elements,
        ...
        self.cutoff = cutoff
        assert secondary_symmetry not in ['circular', 'reflective_circular']
    ...
    def get_sorted_indices(self, symmetry):
        ...
        symmetry : str
            ...
            reflective_planar, chemical, conventional.
        ...
        elif symmetry == 'reflective_planar':
