#!/usr/bin/env python
from boto_brimley.mws.connection import MWSConnection
from boto_brimley.mws.response import (ResponseFactory, ResponseElement, Element,
                               MemberList, ElementList, SimpleList)


from tests.unit import AWSMockServiceTestCase
from boto_brimley.compat import filter, map
