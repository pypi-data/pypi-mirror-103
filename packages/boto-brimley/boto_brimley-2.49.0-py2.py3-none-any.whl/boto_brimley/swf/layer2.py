"""Object-oriented interface to SWF wrapping botobrimley.swf.layer1.Layer1"""

import time
from functools import wraps
from boto_brimley.swf.layer1 import Layer1
from boto_brimley.swf.layer1_decisions import Layer1Decisions
...
class Domain(SWFBase):
    ...
    def executions(self, closed=False, **kwargs):
        ...
        :py:func:`botobrimley.swf.layer1.Layer1.list_closed_workflow_executions` and
        :py:func:`botobrimley.swf.layer1.Layer1.list_open_workflow_executions`
        """
        if closed:
