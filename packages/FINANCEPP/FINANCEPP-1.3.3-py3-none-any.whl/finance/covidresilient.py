...
class CovidResilience:
    def __init__(self, stock_index = "STOXX 600", start_date = "2020-01-19", end_date = "2021-01-19", tickers = None):
    ...
    def run(self):
        ...
        self.rslt.sort_values(by="criterion", axis=1, ascending = False, inplace=True)
