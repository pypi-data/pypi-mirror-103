...
def main():
    ...
    parser.add_argument("input", nargs="+", help="Input to generate coverage from. Can either be 1 or more directories containing the specified structure or an appropriate JSON")
    ...
    if os.path.isdir(args.input[0]):
        ...
        if len(args.input) != 1:
            raise RuntimeError("Invalid num of json imputs. Needs to be 1")
