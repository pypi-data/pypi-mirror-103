...
# @Last Modified time: 2021-04-27 16:56:35
import os
...
class HBRequest(object):
	...
	def getServiceLevelAndTeam(self,service_name,helloBikeToken,
		...
		if response['status']:
			...
			return infos.get('data',{}).get('level',0),info.get('data',{}).get("desc",""),infos.get('data',{}).get('team',{}).get('code',""),infos.get('data',{}).get('team',{}).get('name',"")
		else:
			return 0
