...
class ModbusTcpCommunication(CommunicationProtocol):
    ...
    def write_registers(self, address: int, values: Union[List[int], int]):
        ...
        logging.debug(
            f"Write registers {address} with values {values}"
        )
    ...
    def read_holding_registers(self, address: int, count: int) -> List[int]:
        ...
        logging.debug(
            f"Read holding registers {address} with count {count}."
        )
        ...
        logging.debug(
            f"Returned holding registers {address}: {registers}"
        )
    ...
    def read_input_registers(self, address: int, count: int) -> List[int]:
        ...
        logging.debug(
            f"Read input registers {address} with count {count}."
        )
        ...
        logging.debug(
            f"Returned input registers {address}: {registers}"
        )
