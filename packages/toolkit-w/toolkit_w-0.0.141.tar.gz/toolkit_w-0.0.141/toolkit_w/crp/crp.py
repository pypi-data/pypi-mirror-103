...
class Crp:
    ...
    def prepareDF(self,original_dataset,dateFlag_sep,date_flag_min,lag,items_dataset,customer_name,train_window,sq_pass):
        """
        Params:
            original_dataset ->
            timeFlag         ->
    ...
    def buildDF(self,original_dataset:pd.DataFrame,lag:int,train_window:int,customer_name:string,sq_pass,items_dataset:pd.DataFrame = None):
        """
        Params:
        ...
        output.append(self.prepareDF(original_dataset,dateFlag_sep,date_flag_min,lag,items_dataset,customer_name,train_window,sq_pass))
        print(dateFlag_sep,date_flag_min)
