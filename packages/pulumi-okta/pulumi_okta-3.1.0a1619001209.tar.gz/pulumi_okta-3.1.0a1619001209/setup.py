...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '3.1.0-alpha.1619001209+7ff726ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 3.1.0-alpha.1619001209+7ff726ba`
                """)
            else:
                raise
