...
from media_tools.util.mixcloud import Mix, DEFAULT_CROSSFADE_MS, DEFAULT_MAX_RETRY
...
def parse_commandline(args: List[str]) -> Namespace:
    ...
    parser.add_argument(
        '-e', '--extensions', nargs='+', default=['flac', 'MP3', 'mp3', 'ogg', 'm4a'],
...
def main() -> None:
    ...
    mix = Mix.create(
        ...
        crossfade_ms=opts.crossfade_ms, verbose=opts.verbose, strict=opts.strict
    )
    mix.export()
