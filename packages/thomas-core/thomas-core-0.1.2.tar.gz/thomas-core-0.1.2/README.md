...
### Additional packages
If you're using JupyterLab, I'd recommend also installing the Widget that can display Bayesian Networks. See the [repository](https://github.com/mellesies/thomas-jupyter-widget) for details.
