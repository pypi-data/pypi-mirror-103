...
async def get_auth(
    ...
    if x_secret_token and x_access_token:
        ...
        ehelply_cloud_entity = access.sdk.get_entity_for_key(key_uuid=key.uuid, partition="ehelply-cloud")
        ehelply_resources_entity = access.sdk.get_entity_for_key(key_uuid=key.uuid, partition="ehelply-resources")
