...
def backtest_all_strategies(symbols_only=None, strategy_only=None, root_folder_name=None, pool_size=3):
    """每日策略自动回测"""
    ...
    stats_list_dic: Dict[Tuple[str, str], List[StrategyBacktestStats]] = \
        StrategyBacktestStats.get_available_status_group_by_strategy(
            symbols=symbols_only, strategy_class_name=strategy_only)
