...
def CreateClassifierInstance(
    model, input_shape, num_classes, loss_func=None, framework="pt", preprocessing=None
):
    if framework == "pt":
        if loss_func is not None:
            ...
            classifier = PyTorchClassifier(model, loss_func, input_shape, num_classes, preprocessing=preprocessing)
        else:
