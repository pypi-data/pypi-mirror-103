...
class NPTIngestion(WellsBaseModel):
    ...
    npt_code: Optional[str] = Field(
        None, alias="nptCode", description="The NPT code to identify event.", example="GEKS"
    )
    npt_code_detail: Optional[str] = Field(
        None, alias="nptCodeDetail", description="A written explanation of an NPT event.", example="SSKR"
    )
...
class NPTFilter(WellsBaseModel):
    ...
    npt_code: Optional[str] = Field(
        None, alias="nptCode", description="The NPT code to identify event.", example="FKBX"
    )
    npt_code_detail: Optional[str] = Field(
        None, alias="nptCodeDetail", description="A written explanation of an NPT event.", example="EGOX"
    )
...
class NPT(WellsBaseModel):
    ...
    npt_code: Optional[str] = Field(
        None, alias="nptCode", description="The NPT code to identify event.", example="FELK"
    )
    npt_code_detail: Optional[str] = Field(
        None, alias="nptCodeDetail", description="A written explanation of an NPT event.", example="EOFL"
    )
    npt_level: Optional[str] = Field(
        None, alias="nptLevel", description="defines the level of non-productive time for the activity.", example="0"
    )
...
class WellFilter(WellsBaseModel):
    ...
    water_depth: Optional[DoubleRangeWithUnit] = Field(None, alias="waterDepth")
