...
class PyPiSearch:
    ...
    async def pypi_search(cls, keyword: str) -> list:
        ...
        if ul is None:
            ...
            return list(cls().parse_pypi_results(html, keyword))
    ...
    def parse_pypi_results(self, raw_html, keyword):
        ...
        if ul is None:
            ...
            for result in result_block:
                ...
                if name and link:
                    yield PyPiProject(
                        {"name": name, "description": description, "version": version, "released": release,
