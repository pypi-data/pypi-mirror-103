...
def pcam_patches(
    ...
    if subset == 'train':
        ...
        return PCAM(imgs_hdf5_filepath=imgs_hdf5_filepath, labels_hdf5_filepath=labels_hdf5_filepath, transform=transformation)
    elif subset == 'eval':
...
class PCAM(Dataset):
    ...
    def __init__(self, imgs_hdf5_filepath: str, labels_hdf5_filepath: str, imgs_key: str = 'x', labels_key: str = 'y', transform: O[Compose] = None):
        """
        Initializes dataset.
        """
