...
class MPIEnrolRequest(object):
    ...
    def generate_xml(self):
        ...
        ECommerceConnect.set('xsi:noNamespaceSchemaLocation', 'https://secure.upc.ua/go/pub/schema/xmlpay-1.20.xsd')
        ...
        res = ET.tostring(ECommerceConnect, encoding='utf8', method='xml').decode()
        return res
