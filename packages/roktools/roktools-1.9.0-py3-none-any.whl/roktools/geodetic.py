...
class Coordinates(object):
    ...
    def lla(self, radians=False, a=WGS84_A, e=WGS84_E):
        return xyz_to_lla(self.x, self.y, self.z, radians=radians, a=a, e=e)

    def __repr__(self):
        return f'{self.x:.3f} {self.y:.3f} {self.z:.3f}'

    @staticmethod
    def from_lla(longitude_deg, latitude_deg, height_m, a=WGS84_A, e=WGS84_E):
        """
