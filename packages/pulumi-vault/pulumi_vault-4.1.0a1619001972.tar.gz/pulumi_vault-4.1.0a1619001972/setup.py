...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.1.0-alpha.1619001972+3ca610cc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.1.0-alpha.1619001972+3ca610cc`
                """)
            else:
                raise
