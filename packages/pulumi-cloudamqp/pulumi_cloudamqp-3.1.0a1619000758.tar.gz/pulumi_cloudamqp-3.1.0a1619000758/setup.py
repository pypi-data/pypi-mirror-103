...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '3.1.0-alpha.1619000758+91af951a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 3.1.0-alpha.1619000758+91af951a`
                """)
            else:
                raise
