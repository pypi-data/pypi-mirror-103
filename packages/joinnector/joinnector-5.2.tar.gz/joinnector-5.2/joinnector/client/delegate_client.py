...
class DelegateClient(object):
	def __init__(self, sdk, not_allowed_controller_method_names=None):
		...
		self.not_allowed_controller_method_names = ["reward_deals", "create_leads", "save_leads", "get_subscriptions", "create_taskactivities", "create_wallets", "create_wallettransactions"] if (not_allowed_controller_method_names is None) else not_allowed_controller_method_names
