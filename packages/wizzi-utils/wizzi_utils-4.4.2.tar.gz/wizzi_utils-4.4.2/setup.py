...
setup(
    ...
    version='4.4.2',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/2easy4wizzi/2021wizzi_utils/archive/refs/tags/v_4.4.2.tar.gz',
