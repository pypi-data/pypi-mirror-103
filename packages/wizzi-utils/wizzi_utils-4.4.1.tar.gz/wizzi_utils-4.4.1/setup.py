...
setup(
    ...
    packages=[
        'wizzi_utils',
        'wizzi_utils/temp_sub_package',
        'wizzi_utils/temp_sub_package/test'
    ],  # main package and sub packages
    version='4.4.1',  # Start with a small number and increase it with every change you make
    ...
    download_url='https://github.com/2easy4wizzi/2021wizzi_utils/archive/refs/tags/v_4.4.1.tar.gz',
