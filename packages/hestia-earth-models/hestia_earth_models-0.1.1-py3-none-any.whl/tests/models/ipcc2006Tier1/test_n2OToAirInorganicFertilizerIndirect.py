...
from hestia_earth.models.ipcc2006Tier1.n2OToAirInorganicFertilizerIndirect import TERM_ID, run, _should_run

class_path = f"hestia_earth.models.ipcc2006Tier1.{TERM_ID}"
fixtures_folder = f"{fixtures_path}/ipcc2006Tier1/{TERM_ID}"


class TestN2OToAirInorganicFertilizerIndirect(unittest.TestCase):
