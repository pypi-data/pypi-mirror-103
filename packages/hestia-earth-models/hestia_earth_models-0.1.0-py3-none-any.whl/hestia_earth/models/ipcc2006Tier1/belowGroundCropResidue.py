...
from hestia_earth.models.utils.property import _get_property_by_key
from . import MODEL
...
def _run(primary_product: dict):
    dm_property = _get_property_by_key(primary_product, PROPERTY_KEY) if primary_product is not None else None
    term_id = primary_product.get('term', {}).get('@id')
