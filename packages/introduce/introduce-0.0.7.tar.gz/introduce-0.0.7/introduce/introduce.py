...
class Email:
    ...
    def send(self, send_text, title="자기소개서", image=None):
        try:
            # 이메일 제목
            msg = MIMEMultipart()
            msg['Subject'] = title
            ...
            raise email_error("Username and Password not accepted. Learn more at https://support.google.com/mail/?p=BadCredentials")