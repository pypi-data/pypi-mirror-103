...
class TDA():
    ...
    def UploadFilesToDataset(self, rootPath, basePath="", ext="", batchNum=0):
        ...
        basePath: this param will tell how to reserve file OSS object name, for example:
        -- if your rootPath is /path/to/your/file/dir/
        -- and you set basePath to /path/to/
        -- the filepath(/path/to/your/file/dir/somthing.jpg) upload to the dataset will be your/file/dir/somthing.jpg
        """
        if self.debug:
    ...
    def AddFile(self, filepath, basePath="") -> File:
        """
        ...
        file = File(filepath, basePath, self.filePrefix, self.dataset.endpoint, self.dataset.datasetType)
        self.fileList.append(file)
        if self.debug:
            print(f"[ADD FILE] filepath:{filepath}, basePath:{basePath}")
