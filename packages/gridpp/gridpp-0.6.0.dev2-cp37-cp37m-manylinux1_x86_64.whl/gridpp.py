...
class VariedStructure(StructureFunction):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, points, h_max):
        _gridpp.VariedStructure_swiginit(self, _gridpp.new_VariedStructure(points, h_max))

    def corr(self, p1, p2):
        return _gridpp.VariedStructure_corr(self, p1, p2)

    def clone(self):
        return _gridpp.VariedStructure_clone(self)
    __swig_destroy__ = _gridpp.delete_VariedStructure

# Register VariedStructure in _gridpp:
_gridpp.VariedStructure_swigregister(VariedStructure)
