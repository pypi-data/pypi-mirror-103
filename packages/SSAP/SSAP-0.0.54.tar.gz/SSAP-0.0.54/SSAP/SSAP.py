...
#     plt.plot(x_points, real_func(x_points), c='green', lw=2, label='Ideal curve{eg:y=sin(2Π*x)}')
    ...
    # return p_lsq
    plt.show()
#     plt.savefig("pics\polynomialreg_demo.png")



# import pandas as pd
# df=pd.read_csv('C:/Users/lx379/Python_Tony/tony_lab/showcase_data/pol_reg.csv')
#
#
# polynominalreg(df,'para-1','para-2',9,'demo')
