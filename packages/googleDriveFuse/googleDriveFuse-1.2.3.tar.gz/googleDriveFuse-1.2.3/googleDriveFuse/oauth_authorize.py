...
class OauthAuthorize(object):
    ...
    def __init__(
        ...
        api_credentials = googleDriveFuse.conf.Conf.get('api_credentials')
    ...
    def __get_scopes(self):
        return ' '.join(googleDriveFuse.conf.Conf().scopes)
    ...
    def __refresh_credentials(self):
        ...
        try:
            ...
            raise googleDriveFuse.errors.AuthorizationFailureError("Could not refresh credentials.")
