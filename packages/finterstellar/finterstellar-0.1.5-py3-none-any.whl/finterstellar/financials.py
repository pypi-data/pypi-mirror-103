...
def fn_consolidated(otp, symbol='', term='', vol=100000):
    ...
    '''
    if term!='' or symbol!='':
        url = 'http://192.168.1.18:8000/api/consolidated?otp={}&symbol={}&term={}&vol={}'.format('1612994733102115', symbol, term, vol)
...
def fn_single(otp, symbol='', window='T'):
    ...
    '''
    url = 'http://192.168.1.18:8000/api/single?otp={}&symbol={}&window={}'.format('1612994733102115', symbol, window)
