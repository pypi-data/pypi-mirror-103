...
class ReportBuilder:
    ...
    def __init__(self, report_name, model,app_name):
    ...
    def create_views(self):
        ...
        view_file.write(
            ...
            f"        ctx['object_list'] = []\n"
            f"        ctx['print_url']=reverse_lazy('{self.name_to_snake_case()}_print')\n"
            f"        return ctx\n"
        )

        view_file.write(
            f"\nclass {self.name_to_camel_case()}Print(ImpressaoRelatorio):\n"
    ...
    def create_urls(self):
        ...
        login_required({self.name_to_camel_case()}Print.as_view()),
        name='{self.name_to_snake_case()}_print'),
