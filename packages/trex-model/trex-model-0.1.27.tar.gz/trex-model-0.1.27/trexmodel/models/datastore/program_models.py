...
class ProgramBase(BaseNModel, DictModel):
    ...
    @classmethod
    def update_program_base_data(cls, program, reward_base=None, reward_format=None, desc=None,start_date=None, end_date=None, modified_by=None):
...
class MerchantProgram(ProgramBase):
    ...
    @staticmethod
    def create(merchant_acct, reward_base=None, reward_format=None, desc=None, start_date=None, end_date=None, created_by=None):
