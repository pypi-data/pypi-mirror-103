...
class SpinLattice():
    ...
    # ==============================================
    def addSkyrmion(self, ursprung, vorticity, helicity, c, w, AFM=False, uplo=1, elongation=False, angl_elongation=0.,
                    ab_elongation=[1., 1.]):
        mag = Magnetisation_Skyrmion(self.X, self.Y, ursprung, vorticity, helicity, c, w, AFM, uplo, elongation,
