...
class EnvironmentServiceFactory {
    static createEnvironmentService(name, config) {
        switch (name) {
            case 'local':
                return new localEnvironmentService_1.LocalEnvironmentService(config);
            case 'remote':
                return new remoteEnvironmentService_1.RemoteEnvironmentService(config);
            case 'aml':
                return new amlEnvironmentService_1.AMLEnvironmentService(config);
            case 'openpai':
                return new openPaiEnvironmentService_1.OpenPaiEnvironmentService(config);
            default:
