...
def create_video(list_comp_data, path_video, job_id):
    ...
    if not is_compilation:
        ...
        cnt_real_duration=0
        while max_real_duration < 60*2/3 and cnt_real_duration<2:
            max_real_duration*=2
            cnt_real_duration+=1
        ...
        final_clip.write_videofile(tmp_path, fps=24, codec='libx264', logger=logger)
        final_clip.close()
        ...
        clip.write_videofile(tmp_path_maked_loop, fps=24, codec='libx264', logger=logger)
        clip.close()
