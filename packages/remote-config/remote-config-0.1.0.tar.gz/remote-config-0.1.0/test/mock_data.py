...
def feature_data(self, key):
    return {u'default': False, u'clusters': [u'general/clusters/cluster-google-merchant'], u'enable': True}

def invalid_feature_data(self, key):
    return {u'clusters': [u'general/clusters/cluster-google-merchant'], u'enable': True}
