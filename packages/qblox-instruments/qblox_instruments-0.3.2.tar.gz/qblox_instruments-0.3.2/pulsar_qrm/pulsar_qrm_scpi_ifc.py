    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.4.1 fwBuild=09/04/2021-11:58:59 fwHash=0xE770A53F fwDirty=0 kmodVersion=0.4.1 kmodBuild=09/04/2021-11:58:59 kmodHash=0xE770A53F kmodDirty=0 swVersion=0.4.1 swBuild=09/04/2021-11:58:59 swHash=0xE770A53F swDirty=0"
                if build != build_ref:
