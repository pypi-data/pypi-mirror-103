from IaaGeoDataCleaning.CleaningUtils.validate_coordinates import *
from IaaGeoDataCleaning.MapTools.iaa_explore import *
import warnings
warnings.filterwarnings("ignore")

class ValidateData:
    def __init__(self,df=None,lat_col=None,lng_col=None,loc_col=None,ctry_col=None,shapedir=None):
        """ """
        self.df = df
        ...
        self.mTool = MapTool(self.shape_dir)
