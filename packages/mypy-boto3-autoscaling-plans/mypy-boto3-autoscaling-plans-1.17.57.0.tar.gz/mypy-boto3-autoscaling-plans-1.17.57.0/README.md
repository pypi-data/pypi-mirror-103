...
[boto3.AutoScalingPlans 1.17.57](https://boto3.amazonaws.com/v1/documentation/api/1.17.57/reference/services/autoscaling-plans.html#AutoScalingPlans) service
compatible with
