...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        errorInImage = self.generate_error_transparent(transparent_final,errors_to_add)
        # errorOutImage,
        errors_to_add = [ [outsideImg[1],outsideImg_slice] ]
        errorOutImage = self.generate_error_transparent(transparent_final,errors_to_add)

        # insideUpperImage,
        errors_to_add = [ [insideUpperImg[1],insideUpperImg_slice]  ]
        insideUpperImage = self.generate_error_transparent(transparent_final,errors_to_add)
        # insideLowerImage,
        errors_to_add = [ [insideLowerImg[1],insideLowerImg_slice] ]
        insideLowerImage = self.generate_error_transparent(transparent_final,errors_to_add)
        # outsideUpperImage,
        errors_to_add = [ [outsideImg[1],outsideImg_slice[:3]] ]
        outsideUpperImage = self.generate_error_transparent(transparent_final,errors_to_add)
        # outsideLowerImage
        errors_to_add = [ [outsideImg[1],outsideImg_slice[3:]] ]
        outsideLowerImage = self.generate_error_transparent(transparent_final,errors_to_add)
        ...
        resized_request_res = param_transparent_extract(check_image)
        ...
        for i in range(4):
            ...
            tt = np.array(self.show_symmetry_error(img_big_bot,resized_request_res, part,isUpper=False, m_color=[81, 184, 2]).convert('RGBA'))
        ...
        for i in range(3):
            ...
            tt = np.array(self.show_symmetry_error(img_big_top,resized_request_res, part,isUpper=True, m_color=[81, 184, 2]).convert('RGBA'))
            tt[np.all(tt[:, :, 0:3] == (0, 0, 0), 2)] = 0
    ...
    def show_symmetry_error(self,check_image,check_request_res, p,isUpper, m_color=[0,0,0]):
