...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        [insideUpperImage,insideLowerImage,outsideUpperImage,outsideLowerImage]



        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, dict_simmetry_top, dict_simmetry_bottom, dict_simmetry_top_images,dict_simmetry_bottom_images,image_work.apply_errors_on_image(check_image,errors),errorInImage,errorOutImage,[insideUpperImage,insideLowerImage,outsideUpperImage,outsideLowerImage],True
