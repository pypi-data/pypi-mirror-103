...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        print("1")
        # generate all errors
        outsideImg = get_transparent_outside(transparent_image,resized_request_res )
        insideUpperImg = get_transparent_inside(transparent_image= transparent_final,isUpperLip = True,resized_request_res =resized_request_res )
        insideLowerImg = get_transparent_inside(transparent_image= transparent_final,isUpperLip = False,resized_request_res =resized_request_res )
        print("2")
