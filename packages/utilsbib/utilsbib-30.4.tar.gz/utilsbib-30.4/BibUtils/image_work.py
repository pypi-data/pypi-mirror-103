...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, dict_simmetry_top, dict_simmetry_bottom, image_work.apply_errors_on_image(check_image,errors),errorInImage,errorOutImage,True
