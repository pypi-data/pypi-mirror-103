...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, dict_simmetry_top, dict_simmetry_bottom, dict_simmetry_top_images,dict_simmetry_bottom_images,errorImage,errorInImage,errorOutImage,res_group,True
