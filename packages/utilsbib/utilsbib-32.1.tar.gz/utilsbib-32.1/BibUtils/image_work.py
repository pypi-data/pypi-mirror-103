...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        print("1")
        # generate all errors
        outsideImg = self.get_transparent_outside(transparent_final,resized_request_res )
        insideUpperImg = self.get_transparent_inside(transparent_image= transparent_final,isUpperLip = True,resized_request_res =resized_request_res )
        insideLowerImg = self.get_transparent_inside(transparent_image= transparent_final,isUpperLip = False,resized_request_res =resized_request_res )
        print("2")
        ...
        background = transparent_final.copy()
        for i in errors_to_add:
            #print(i[])
            origine = errors_to_add[0][0][0]
            for tile in errors_to_add[0][1]:
                print(tile)
        ...
        img_big_bot = np.array(transparent_final)
        img_big_top = np.array(transparent_final)
        ...
        return upperJsonInside, lowerJsonInside, upperJsonOutside, lowerJsonOutside, dict_simmetry_top, dict_simmetry_bottom, dict_simmetry_top_images,dict_simmetry_bottom_images,transparent_final,errorInImage,errorOutImage,[insideUpperImage,insideLowerImage,outsideUpperImage,outsideLowerImage],True
