...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        for i in range(4):
            ...
            dict_simmetry_bottom_images[part] = self.show_symmetry_error(check_image,check_request_res, part,isUpper=False, m_color=[0,0,0])
        ...
        for i in range(3):
            ...
            dict_simmetry_top_images[part] = self.show_symmetry_error(check_image,check_request_res, part,isUpper=True, m_color=[0,0,0])
