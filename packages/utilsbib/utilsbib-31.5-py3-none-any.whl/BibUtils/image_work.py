...
class FaceChecker:
    ...
    def checkLipstick(self,profile_image, check_image):
        ...
        print("1")
        # generate all errors
        outsideImg = self.get_transparent_outside(transparent_image,resized_request_res )
        ...
        errorInImage = self.generate_error_transparent(transparent_image,errors_to_add)
        # errorOutImage,
        errors_to_add = [ [outsideImg[1],outsideImg_slice] ]
        errorOutImage = self.generate_error_transparent(transparent_image,errors_to_add)

        # insideUpperImage,
        errors_to_add = [ [insideUpperImg[1],insideUpperImg_slice]  ]
        insideUpperImage = self.generate_error_transparent(transparent_image,errors_to_add)
        # insideLowerImage,
        errors_to_add = [ [insideLowerImg[1],insideLowerImg_slice] ]
        insideLowerImage = self.generate_error_transparent(transparent_image,errors_to_add)
        # outsideUpperImage,
        errors_to_add = [ [outsideImg[1],outsideImg_slice[:3]] ]
        outsideUpperImage = self.generate_error_transparent(transparent_image,errors_to_add)
        # outsideLowerImage
        errors_to_add = [ [outsideImg[1],outsideImg_slice[3:]] ]
        outsideLowerImage = self.generate_error_transparent(transparent_image,errors_to_add)
