...
// Hide or unhide alternative displays
function switch_alts() {
    const alts = document.getElementsByClassName("pp-or-button");
    Array.from(alts).forEach(function (alt) {
        if (alt.style.visibility == 'hidden'){
...
module.exports = { pair_emphasize, pair_deemphasize, open_sidebar, close_sidebar, switch_or, copy_clipboard, switch_alts };