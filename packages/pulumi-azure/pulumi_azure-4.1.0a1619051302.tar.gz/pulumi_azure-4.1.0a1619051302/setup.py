...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.1.0-alpha.1619051302+8a0042a9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.1.0-alpha.1619051302+8a0042a9`
                """)
            else:
                raise
