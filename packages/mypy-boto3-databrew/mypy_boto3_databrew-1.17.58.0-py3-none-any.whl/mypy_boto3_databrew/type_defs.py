...
_RequiredDatasetParameterTypeDef = TypedDict(
    ...
    {"Name": str, "Type": Literal["Datetime", "Number", "String"]},
)
...
_OptionalDatasetTypeDef = TypedDict(
    "_OptionalDatasetTypeDef",
    {
        ...
        "LastModifiedBy": str,
        "Source": Literal["S3", "DATA-CATALOG", "DATABASE"],
...
_OptionalFilesLimitTypeDef = TypedDict(
    ...
    {"OrderedBy": Literal["LAST_MODIFIED_DATE"], "Order": Literal["DESCENDING", "ASCENDING"]},
    total=False,
)
