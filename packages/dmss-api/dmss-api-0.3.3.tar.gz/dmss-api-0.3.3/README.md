...
*DefaultApi* | [**get_blueprint**](docs/DefaultApi.md#get_blueprint) | **GET** /api/v1/blueprint/{type_ref} | Get Blueprint
...
## Documentation For Models
 ...
 - [GetDocumentByPathResponse](docs/GetDocumentByPathResponse.md)
