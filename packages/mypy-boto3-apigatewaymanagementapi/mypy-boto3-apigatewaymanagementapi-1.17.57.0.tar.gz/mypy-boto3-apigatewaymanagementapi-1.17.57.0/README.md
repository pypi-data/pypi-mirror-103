...
[boto3.ApiGatewayManagementApi 1.17.57](https://boto3.amazonaws.com/v1/documentation/api/1.17.57/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service
compatible with
