...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'rabbitmq', '3.1.0-alpha.1619000879+f870269a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource rabbitmq 3.1.0-alpha.1619000879+f870269a`
                """)
            else:
                raise
