...
from videotools.commands import cipher, git, ssh, cdn
...
class VitoolsScript:
    ...
    def init_parser():
        ...
        ssh.init_parser(subparsers)
        cdn.init_parser(subparsers)
    ...
    def run(self):
        ...
        elif self.script_args.command == COMMANDS.SSH:
            ssh.command(self.script_args)
        elif self.script_args.command == COMMANDS.CDN:
            cdn.command(self.script_args)
