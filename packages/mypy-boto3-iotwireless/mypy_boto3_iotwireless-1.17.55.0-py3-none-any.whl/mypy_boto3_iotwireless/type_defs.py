...
CertificateListTypeDef = TypedDict(
    "CertificateListTypeDef", {"SigningAlg": Literal["Ed25519", "P256r1"], "Value": str}
)
...
SidewalkDeviceMetadataTypeDef = TypedDict(
    ...
    {
        "Rssi": int,
        "BatteryLevel": Literal["normal", "low", "critical"],
        "Event": Literal["discovered", "lost", "ack", "nack", "passthrough"],
        "DeviceState": Literal[
