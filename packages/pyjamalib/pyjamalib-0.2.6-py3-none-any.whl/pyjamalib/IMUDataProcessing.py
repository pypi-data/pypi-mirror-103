...
class IMUDataProcessing:
    ...
    def joint_measures(df_first_joint,df_second_joint,patternRoll=False,patternPitch=False,patternYaw=False,init=0,end=None,freq=75,threshold=0,cicle=2,bias=0,poly_degree=9,IC=1.96):
        ...
        if patternRoll:
            rR,rawRrom = IMUDataProcessing.pattern_extraction(df['Flex/Ext'],df['Time'],threshold=np.mean(df['Flex/Ext']), bias=bias, cicle=cicle);
            rawRoll = IMUDataProcessing.patternIC(rR[:,0],rR[:,1],poly_degree=poly_degree,IC=IC, df=False);
            rm_R = IMUDataProcessing.IMUDataProcessing.rom_mean(rawRrom)
            CFR,CFRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF'],df['Time'],threshold=np.mean(df['Flex/Ext_CF']), bias=bias, cicle=cicle);
            ...
            CFGDR,CFGDRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF_GD'],df['Time'],threshold=np.mean(df['Flex/Ext_CF_GD']), bias=bias, cicle=cicle);
            ...
            CFGNR,CFGNRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF_GN'],df['Time'],threshold=np.mean(df['Flex/Ext_CF_GN']), bias=bias, cicle=cicle);
            ...
            KGDR,KGDRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GD'],df['Time'],threshold=np.mean(df['Flex/Ext_Kalman_GD']), bias=bias, cicle=cicle);
            ...
            KGNR,KGNRRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GN'],df['Time'],threshold=np.mean(df['Flex/Ext_Kalman_GN']), bias=bias, cicle=cicle);
            ...
            MADR,MADRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Madgwick'],df['Time'],threshold=np.mean(df['Flex/Ext_Madgwick']), bias=bias, cicle=cicle);
        ...
        if patternPitch:    
            rP,rawProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd'],df['Time'],threshold=300, bias=bias, cicle=cicle);
            ...
            CFP,CFProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF'],df['Time'],threshold=260, bias=bias, cicle=cicle);
            ...
            CFGDP,CFGDProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF_GD'],df['Time'],threshold=175, bias=bias, cicle=cicle);
            ...
            CFGNP,CFGNProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF_GN'],df['Time'],threshold=178.5, bias=bias, cicle=cicle);
            ...
            KGDP,KGDProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GD'],df['Time'],threshold=178, bias=bias, cicle=cicle);
            ...
            KGNP,KGNProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GN'],df['Time'],threshold=178, bias=bias, cicle=cicle);
            ...
            MADP,MADProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Madgwick'],df['Time'],threshold=180, bias=bias, cicle=cicle);
        ...
        if patternYaw:
            rY,rawYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot'],df['Time'],threshold=170, bias=bias, cicle=cicle);
            ...
            CFY,CFYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF'],df['Time'],threshold=170, bias=bias, cicle=cicle);
            ...
            CFGDY,CFGDYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GD'],df['Time'],-49.2, bias=bias, cicle=cicle);
            ...
            CFGNY,CFGNYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GN'],df['Time'],threshold=-50.5, bias=bias, cicle=cicle);
            ...
            KGDY,KGDYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GD'],df['Time'],threshold=-0.05, bias=bias, cicle=cicle);
            ...
            KGNY,KGNYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GN'],df['Time'],threshold=np.mean(df['Int/Ext_Rot_Kalman_GN']), bias=bias, cicle=cicle);
            ...
            MADY,MADYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Madgwick'],df['Time'],threshold=-56.5, bias=bias, cicle=cicle);
    ...
    def KalmanGD(acc,gyr,mag,gyrcalib = None,dt = 1/75,R_In=[0.01,0.01,0.01,0.01],beta=.05,conj = True):
        ...
        mag: ndarray 
           Magnetometer array with XYZ in mG.
        gyrcalib: ndarray
           Calibration data from gyroscope array
           with XYZ in rad/s.
        dt: float
           Sample time.
        R_In: tuple
