...
class RpmRpmRepository(object):
    ...
    def __init__(self, pulp_labels=None, name=None, description=None, remote=None, autopublish=False, metadata_signing_service=None, retain_package_versions=None, metadata_checksum_type=None, package_checksum_type=None, gpgcheck=0, repo_gpgcheck=0, sqlite_metadata=False, local_vars_configuration=None):  # noqa: E501
