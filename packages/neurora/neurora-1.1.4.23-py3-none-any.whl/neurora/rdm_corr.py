...
def rdm_correlation_pearson(RDM1, RDM2, rescale=False, permutation=False, iter=5000):
...
def rdm_correlation_kendall(RDM1, RDM2, rescale=False, permutation=False, iter=5000):
