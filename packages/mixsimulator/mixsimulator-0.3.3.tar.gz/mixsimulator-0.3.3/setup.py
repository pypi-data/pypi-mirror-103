...
setuptools.setup(
    ...
    package_data={'mixsimulator': ['data/RIToamasina/dataset_RI_Toamasina.csv','data/RIToamasina/dataset_RI_Toamasina_v2.csv','data/RIToamasina/dataset_RI_Toamasina_variation_template.csv','data/RIToamasina/DIR-TOAMASINA_concat.csv','LICENSE']},
    classifiers=[
