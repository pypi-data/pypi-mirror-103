...
class DataKeeperJSONEncoder(JSONEncoder):
...
class DjangoDataKeeperJSONEncoder(DjangoJSONEncoder):
...
class DataKeeperRenderer(JSONRenderer):
    encoder_class = DataKeeperJSONEncoder
