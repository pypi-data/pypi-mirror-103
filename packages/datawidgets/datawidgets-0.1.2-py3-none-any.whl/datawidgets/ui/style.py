...
class CSS_NAMES:
    ...
    CLASS_MAP_ADDITION_BOX = "class-map-addition-box"
    CLASS_MAP_ADDITION_BUTTON = "class-map-addition-button"
    CLASS_MAP_ADDITION_CONTROLS = "class-map-addition-controls"
