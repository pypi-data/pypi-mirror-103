...
[boto3.CostandUsageReportService 1.17.56](https://boto3.amazonaws.com/v1/documentation/api/1.17.56/reference/services/cur.html#CostandUsageReportService) service
compatible with
