...
class CogConverter(commands.Converter):
    ...
    async def convert(self, ctx: commands.Context, argument: str) -> commands.Cog:
        """Attempts to convert a string into a named cog
        ...
        Raises
        ------
        `commands.BadArgument` if the cog was not found
        """

        cog = ctx.bot.get_cog(argument)
        if cog is None:
            raise commands.BadArgument(f"No cog named \"{argument}\" found")
        return cog
...
class AnyChannel(commands.Converter):
    ...
    async def convert(self, ctx: commands.Context, argument: str):
        ...
        Raises
        ------
        `commands.BadArgument` if the channel was not found
        """
        ...
        try:
            ...
            try:
                ...
                raise commands.BadArgument(f"Couldn't convert {argument!r} into a global channel to fetch")
            else:
