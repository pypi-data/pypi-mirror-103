...
class DiscordBot(commands.Bot):
    ...
    async def send_success_embed(self, ctx: discord.abc.Messageable, content: str):
        ...
        embed = get_base_embed(description=f"{emoji} {content}", color=discord.Color.green())
    ...
    async def send_fail_embed(self, ctx: discord.abc.Messageable, content: str):
        ...
        emoji = ":x:"
        embed = get_base_embed(description=f"{emoji} {content}", color=discord.Color.red())
        await ctx.send(embed=embed)
    ...
    async def send_warn_embed(self, ctx: discord.abc.Messageable, content: str):
        ...
        emoji = ":warning:"
        embed = get_base_embed(description=f"{emoji} {content}", color=discord.Color.gold())
        await ctx.send(embed=embed)
