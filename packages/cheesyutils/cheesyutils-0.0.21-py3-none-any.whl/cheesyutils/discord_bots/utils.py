...
def get_discord_color(color: Union[discord.Color, tuple, str]) -> discord.Color:
    ...
    print(f"Color is discord.Color: {color is discord.Color}")
    print(f"Color is discord.Colour: {color is discord.Colour}")
    print(f"Color isinstance of discord.Color: {isinstance(color, discord.Color)}")
    print(f"Color isinstance of discord.Colour: {isinstance(color, discord.Colour)}")
    print(f"Color isinstance of discord.Color or discord.Colour: {isinstance(color, (discord.Color, discord.Colour))}")
...
def slice_string(string: str, max_length: int) -> List[str]:
