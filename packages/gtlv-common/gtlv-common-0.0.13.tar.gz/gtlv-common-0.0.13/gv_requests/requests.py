...
class Requests:
    ...
    async def _get_data_quality(self, fromdatetime: datetime, todatetime: datetime, locationeids: list,
                                period: str, sampling: str, window: str, applyto: str, params: dict = None) -> list:
    ...
    async def __get_data(self, fromdatetime: datetime, todatetime: datetime, locationeids: list, period: str,
                         sampling: str, window: str, applyto: str, params) -> list:
        if params is None:
            params = {}
    ...
    async def get_zone_travel_time(self, frompointeid: str, topointeid: str, fromdatetime: datetime,
                                   todatetime: datetime, period: str, sampling: str) -> list:
        params = {
    ...
    async def _get(self, suffix: str, params: dict = None) -> list:
        if params is None:
            params = {}
