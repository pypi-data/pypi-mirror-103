...
class FileFileRepositoryResponse(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, versions_href=None, pulp_labels=None, latest_version_href=None, name=None, description=None, remote=None, autopublish=False, manifest='PULP_MANIFEST', local_vars_configuration=None):  # noqa: E501
