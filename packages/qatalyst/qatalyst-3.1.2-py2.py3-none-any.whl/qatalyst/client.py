...
class HTTPClient:
    ...
    def jobinfo(self):
        jobinfo = {
            ...
            'job_started_utc': self.job_finished_dt_utc.strftime('%Y-%m-%dT%H:%M:%S.%fZ'),   # elasticsearch strict_date_optional_time_nanos format
...
class ClientService(HTTPClient):
    ...
    def __init__(self,
        ...
        # If url has not been set by any other method, default it here.
        if not self.url:
