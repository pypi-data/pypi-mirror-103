...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.1.0-alpha.1619559419+dd261f6c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.1.0-alpha.1619559419+dd261f6c`
                """)
            else:
                raise
