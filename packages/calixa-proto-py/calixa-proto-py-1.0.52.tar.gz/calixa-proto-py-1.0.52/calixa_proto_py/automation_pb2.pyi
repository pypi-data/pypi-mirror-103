...
class MetricRateOfChangeCondition(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...

    def __init__(self,
        ) -> None: ...
type___MetricRateOfChangeCondition = MetricRateOfChangeCondition
...
class ConditionOrGroup(google___protobuf___message___Message):
    ...
    @property
    def metric_rate_of_change_condition(self) -> type___MetricRateOfChangeCondition: ...
    ...
    def __init__(self,
        *,
        ...
        metric_rate_of_change_condition : typing___Optional[type___MetricRateOfChangeCondition] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group",u"metric_rate_of_change_condition",b"metric_rate_of_change_condition",u"metric_threshold_condition",b"metric_threshold_condition"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"condition",b"condition",u"conditionOrGroup",b"conditionOrGroup",u"group",b"group",u"metric_rate_of_change_condition",b"metric_rate_of_change_condition",u"metric_threshold_condition",b"metric_threshold_condition"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions___Literal[u"conditionOrGroup",b"conditionOrGroup"]) -> typing_extensions___Literal["condition","group","metric_threshold_condition","metric_rate_of_change_condition"]: ...
...
class MetricTrigger(google___protobuf___message___Message):
    ...
    @property
    def trigger(self) -> type___ConditionOrGroup: ...

    def __init__(self,
        *,
        trigger : typing___Optional[type___ConditionOrGroup] = None,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"trigger",b"trigger"]) -> builtin___bool: ...
