...
[boto3.ElasticBeanstalk 1.17.56](https://boto3.amazonaws.com/v1/documentation/api/1.17.56/reference/services/elasticbeanstalk.html#ElasticBeanstalk) service
compatible with
