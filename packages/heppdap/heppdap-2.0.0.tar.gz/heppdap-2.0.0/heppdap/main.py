...
class MainFrame(wx.Frame):
    def __init__(self, title="HEPPDAP", pos=(100,100)):
    ...
    def InitFrame(self):
        ...
        #About
        aboutitem = fileMenu.Append(wx.ID_ANY, "About", "About") 
        #Bind Item
        self.Bind(wx.EVT_MENU, self.panel.about, aboutitem)
...
class PlotNotebook(wx.Panel):
    ...
    def __init__(self, parent, id, pos, size):
        ...
        self.parent = parent
        atext = wx.StaticText(self, wx.ID_ANY, "Analysis")
...
#                         all_events.rename_axis("Time (ns)", axis = "index", inplace=True)
    ...
    def about(self, event):
        msg = "High Energy Particle Physics Data Analysis Program (HEPPDAP). \nDeveloped by Brandon J. Weindorf. \nGit: https://github.com/bweindorf/highenergy"
        wx.MessageBox(msg, "About HEPPDAP", wx.OK | wx.ICON_INFORMATION)
