...
from ._util._utils import _get_parameter_static_value, _sanitize_python_variable_name, _get_valid_directory_path, \
...
class ModuleNode(NodeBase):
    ...
    def export_attribute(self, provider, directory_path, separate_file, parent_pipeline):
        ...
        runsetting_dict = {k: _get_parameter_static_value(v) for k, v in runsetting_dict.items()}
