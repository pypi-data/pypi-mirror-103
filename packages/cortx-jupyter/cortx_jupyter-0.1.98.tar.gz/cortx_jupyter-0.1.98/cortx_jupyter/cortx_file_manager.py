...
def _put_object(config, bucket, body, object_name):
    s3_client = boto3.client('s3', aws_access_key_id=config['access_key_id'], aws_secret_access_key=config['secret_access_key'], region_name='us-east-1', endpoint_url= config['endpoint_url']) 
