...
AUTH_SERVER_URI="http://localhost:5001"
...
class OkeraCredentialProvider(CredentialProvider):
    ...
    def __init__(self, rest_api_url, user, token, token_source='config', verify_ssl=False):
        ...
        self._okera_token = self._resolve_token(user, token, token_source)
    ...
    def _read_token(self, token_file, user):
        try:
