        ...
        with common.get_planner(ctx) as conn:
            ...
            conn.execute_ddl(
                ("GRANT SELECT ON TABLE jdbc_test_snowflake.all_types " +
                 "WHERE sets_intersect(`string`, 'hello') " +
...
TBLPROPERTIES (
    ...
    'spark.sql.sources.provider'='parquet')''' %  DB)
            ...
            """
            Iterations 50
            Mean 107.762131690979 ms
            50%: 104.90894317626953 ms
            90%: 114.89295959472656 ms
            95%: 137.50886917114258 ms
            99%: 158.87045860290527 ms
            99.5%: 158.87045860290527 ms
            99.9%: 158.87045860290527 ms
            """
            #common.measure_latency(50, admin_auth)

            """
            Iterations 50
            Mean 1162.7174043655396 ms
            50%: 1146.277666091919 ms
            90%: 1245.729923248291 ms
            95%: 1260.2534294128418 ms
            99%: 1425.736904144287 ms
            99.5%: 1425.736904144287 ms
            99.9%: 1425.736904144287 ms
            """
    ...
    def test_yotpo_perf(self):
        ...
        with common.get_planner(ctx) as conn:
            ...
            """
            Iterations 50
            Mean 1168.7848138809204 ms
            50%: 1156.9626331329346 ms
            90%: 1224.28560256958 ms
            95%: 1236.9940280914307 ms
            99%: 1390.042781829834 ms
            99.5%: 1390.042781829834 ms
            99.9%: 1390.042781829834 ms
            """
            #common.measure_latency(50, user_auth)
