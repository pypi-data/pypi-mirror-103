...
# -*- coding: utf-8 -*-
#
# ipydraw documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipydraw', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipydraw.tex', 'ipydraw Documentation',
     'Travis DePrato', 'manual'),
]
