...
env.globals['ljust'] = str.ljust
env.globals['rjust'] = str.rjust
...
def run():
    console.print(f"-----------GenCode ver:{VER}----------------", style="bold blue")
    console.print(f"-----------作者：liuzhuogood@foxmail.com-----", style="dim")
    inputs = sys.argv
    if len(inputs) < 2:
