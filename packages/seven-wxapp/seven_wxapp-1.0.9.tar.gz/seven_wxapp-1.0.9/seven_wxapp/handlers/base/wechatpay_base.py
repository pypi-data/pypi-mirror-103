...
@LastEditTime: 2021-04-21 09:16:15
...
class WeiXinPayRequest(object):
    ...
    def get_prepay_id(self, unifiedorder_url, params):
        ...
        if xmlresp['xml']['return_code'] == 'SUCCESS':
            if xmlresp['xml']['result_code'] == 'SUCCESS':
                ...
                self.logging_link_error(f"【{params['out_trade_no']},微信统一下单获取prepay_id】" + xmlresp['xml']['err_code_des'])
                return WeixinError(xmlresp['xml']['err_code_des'])
        else:
            self.logging_link_error(f"【{params['out_trade_no']},微信统一下单获取prepay_id】" + xmlresp['xml']['return_msg'])
    ...
    def query_order(self, out_trade_no="", transaction_id=""):
        ...
        try:
            ...
            self.logging_link_error(f"【微信查询订单】" + str(ex) + ":" + str(xml))
    ...
    def close_order(self, out_trade_no=""):
        ...
        try:
            ...
            self.logging_link_error(f"【微信关闭订单】" + str(ex))
