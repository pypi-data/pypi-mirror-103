...
class WeiXinHelper:
    ...
    def decrypted_data(self, open_id, code, encrypted_Data, iv):
        ...
        try:
            ...
            self.logging_link_error(str(ex) + "【微信decrypted_data】")
