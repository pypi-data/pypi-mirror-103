...
class AFM:
    ...
    def nanosurf_import(
        ...
        self.z_approach = np.array(_z_approach, dtype=object)
        self.z_withdraw = np.array(_z_withdraw, dtype=object)
    ...
    def baseline(
        ...
        for curve_number in range(0, self.approach_raw.shape[1]):
