...
full-screen or not.
- debounce (number; default 0): When using the spinner as a loading spinner, add a time delay to the
spinner being removed to prevent flickering."""
    ...
    def __init__(self, children=None, id=Component.UNDEFINED, fullscreen_style=Component.UNDEFINED, spinner_style=Component.UNDEFINED, fullscreenClassName=Component.UNDEFINED, spinnerClassName=Component.UNDEFINED, color=Component.UNDEFINED, type=Component.UNDEFINED, size=Component.UNDEFINED, fullscreen=Component.UNDEFINED, debounce=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'fullscreen_style', 'spinner_style', 'fullscreenClassName', 'spinnerClassName', 'color', 'type', 'size', 'fullscreen', 'debounce']
        self._type = 'Spinner'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'fullscreen_style', 'spinner_style', 'fullscreenClassName', 'spinnerClassName', 'color', 'type', 'size', 'fullscreen', 'debounce']
