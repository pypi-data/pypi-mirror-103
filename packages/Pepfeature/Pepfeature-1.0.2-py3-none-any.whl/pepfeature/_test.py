"""
    ...
    Usage:
        If pepfeature module is imported than call pepfeature.test.main()
        or execute this script directly within the pepfeature package.
...
if __name__ == '__main__':
    ...
    sample_df = pep.aa_all_feat.calc_df(dataframe=sample_df, k=2, Ncores=1)
