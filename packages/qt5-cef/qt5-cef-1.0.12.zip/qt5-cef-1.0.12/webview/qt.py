...
def launch_main_window(uid, title, url, width, height, resizable, full_screen, min_size,
    ...
    #     #发布mac包用到的
    #     settings["framework_dir_path"]=os.path.abspath("Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/cefpython3/Chromium Embedded Framework.framework")
    #     settings["browser_subprocess_path"]=os.path.abspath("Library/Frameworks/Python.framework/Versions/3.5/lib/python3.5/site-packages/cefpython3/subprocess")
