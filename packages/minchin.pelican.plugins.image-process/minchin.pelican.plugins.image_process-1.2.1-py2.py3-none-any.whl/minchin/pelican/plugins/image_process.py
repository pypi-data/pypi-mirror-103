...
__copyright__ = "Copyright 2015-16 Whisky Echo Bravo, Copyright 2016-21 William Minchin."
...
logger.warn(
    "This package name (`minchin.pelican.plugins.image_process`) has been "
    "deprecated. Upgrade to `pelican-image-process` on PyPI."
)
