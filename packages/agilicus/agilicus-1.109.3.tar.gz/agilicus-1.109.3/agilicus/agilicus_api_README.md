...
*ApplicationServicesApi* | [**get_application_service_billable_metrics**](agilicus_api/docs/ApplicationServicesApi.md#get_application_service_billable_metrics) | **GET** /v2/application_services/billable_metrics | Get application service metrics
*ApplicationServicesApi* | [**get_file_share_billable_metrics**](agilicus_api/docs/ApplicationServicesApi.md#get_file_share_billable_metrics) | **GET** /v1/file_share_services/billable_metrics | Get file share service metrics
...
*ApplicationsApi* | [**get_all_billable_metrics**](agilicus_api/docs/ApplicationsApi.md#get_all_billable_metrics) | **GET** /v1/resources/billable_metrics | Get all resource metrics for the Applications API
...
*ApplicationsApi* | [**get_application_billable_metrics**](agilicus_api/docs/ApplicationsApi.md#get_application_billable_metrics) | **GET** /v2/applications/billable_metrics | Get application metrics
...
## Documentation For Models
 ...
 - [BillableMeasurement](agilicus_api/docs/BillableMeasurement.md)
 - [BillableMetric](agilicus_api/docs/BillableMetric.md)
 - [BillableMetrics](agilicus_api/docs/BillableMetrics.md)
