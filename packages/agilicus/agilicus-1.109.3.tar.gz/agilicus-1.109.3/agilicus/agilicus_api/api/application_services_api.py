...
class ApplicationServicesApi(object):
    ...
    def get_application_service_billable_metrics(self, org_id, **kwargs):  # noqa: E501
        """Get application service metrics  # noqa: E501

        Retrieves all application service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_application_service_billable_metrics(org_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_application_service_billable_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_application_service_billable_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get application service metrics  # noqa: E501

        Retrieves all application service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_application_service_billable_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(BillableMetric, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_application_service_billable_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_application_service_billable_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/application_services/billable_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='BillableMetric',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_file_share_billable_metrics(self, org_id, **kwargs):  # noqa: E501
        """Get file share service metrics  # noqa: E501

        Retrieves all file share service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_share_billable_metrics(org_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_file_share_billable_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_file_share_billable_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get file share service metrics  # noqa: E501

        Retrieves all file share service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_share_billable_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_file_share_billable_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_file_share_billable_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/file_share_services/billable_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
