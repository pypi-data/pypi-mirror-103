...
@cli.command(name="show-application-api-billable-metrics")
@click.option("--org-id", default=None)
@click.pass_context
def show_application_api_billable_metrics(ctx, **kwargs):
    result = apps.show_application_api_billable_metrics(ctx, **kwargs)
    table = apps.format_billable_metrics(ctx, result)
    print(table)


@cli.command(name="show-application-billable-metrics")
@click.option("--org-id", default=None)
@click.pass_context
def show_application_billable_metrics(ctx, **kwargs):
    result = apps.show_application_billable_metrics(ctx, **kwargs)
    output_entry(ctx, result.to_dict())


@cli.command(name="show-application-service-billable-metrics")
@click.option("--org-id", default=None)
@click.pass_context
def show_application_service_billable_metrics(ctx, **kwargs):
    result = apps.show_application_service_billable_metrics(ctx, **kwargs)
    output_entry(ctx, result.to_dict())


@cli.command(name="show-file-share-billable-metrics")
@click.option("--org-id", default=None)
@click.pass_context
def show_file_share_billable_metrics(ctx, **kwargs):
    result = apps.show_file_share_billable_metrics(ctx, **kwargs)
    output_entry(ctx, result.to_dict())
