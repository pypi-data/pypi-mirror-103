...
class TestApplicationServicesApi(unittest.TestCase):
    ...
    def test_get_application_service_billable_metrics(self):
        """Test case for get_application_service_billable_metrics

        Get application service metrics  # noqa: E501
        """
        pass

    def test_get_file_share_billable_metrics(self):
        """Test case for get_file_share_billable_metrics
