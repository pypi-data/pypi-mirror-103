...
class TestApplicationsApi(unittest.TestCase):
    ...
    def test_get_all_billable_metrics(self):
        """Test case for get_all_billable_metrics
    ...
    def test_get_application_billable_metrics(self):
        """Test case for get_application_billable_metrics
