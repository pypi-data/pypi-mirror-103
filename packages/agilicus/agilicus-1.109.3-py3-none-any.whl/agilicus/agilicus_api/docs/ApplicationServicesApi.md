...
[**get_application_service_billable_metrics**](ApplicationServicesApi.md#get_application_service_billable_metrics) | **GET** /v2/application_services/billable_metrics | Get application service metrics
[**get_file_share_billable_metrics**](ApplicationServicesApi.md#get_file_share_billable_metrics) | **GET** /v1/file_share_services/billable_metrics | Get file share service metrics
...
# **get_application_service_billable_metrics**
> BillableMetric get_application_service_billable_metrics(org_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get application service metrics
        api_response = api_instance.get_application_service_billable_metrics(org_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ApplicationServicesApi->get_application_service_billable_metrics: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Return application service billable metrics |  -  |

[[Back to top]](#) [[Back to API list]](../README.md#documentation-for-api-endpoints) [[Back to Model list]](../README.md#documentation-for-models) [[Back to README]](../README.md)

# **get_file_share_billable_metrics**
> BillableMetric get_file_share_billable_metrics(org_id)
...
with agilicus_api.ApiClient(configuration) as api_client:
    ...
    try:
        # Get file share service metrics
        api_response = api_instance.get_file_share_billable_metrics(org_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling ApplicationServicesApi->get_file_share_billable_metrics: %s\n" % e)
```
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
**200** | Return file share services billable metrics |  -  |
