...
class SessionController:
    ...
    def up(
        ...
        message = (
            "Warning: `anyscale up` will be deprecated in the near future. The Anyscale "
            "product will no longer support syncing file mounts that are outside the "
            "project directory. Please try using `anyscale.connect()` or `anyscale start` "
            "for your use case and let the Anyscale team know if you are having any issues."
        )
