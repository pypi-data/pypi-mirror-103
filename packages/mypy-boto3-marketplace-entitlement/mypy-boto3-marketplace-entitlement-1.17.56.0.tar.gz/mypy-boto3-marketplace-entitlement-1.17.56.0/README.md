...
[boto3.MarketplaceEntitlementService 1.17.56](https://boto3.amazonaws.com/v1/documentation/api/1.17.56/reference/services/marketplace-entitlement.html#MarketplaceEntitlementService) service
compatible with
