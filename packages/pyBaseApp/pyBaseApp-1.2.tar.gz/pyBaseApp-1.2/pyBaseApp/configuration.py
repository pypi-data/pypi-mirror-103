...
class Configuration:
    ...
    def __init__(self, loggerfolder='logs/', loggerlevelconsole = logging.ERROR, loggerlevelfile = logging.DEBUG):
        self.loggerfolder = loggerfolder
        self._defaultLogger(loggerlevelconsole, loggerlevelfile)
    ...
    def _defaultLogger(self, loggerlevelconsole, loggerlevelfile):
        ...
        console_handler.setLevel(loggerlevelconsole)
        ...
        file_handler.setLevel(loggerlevelfile)
