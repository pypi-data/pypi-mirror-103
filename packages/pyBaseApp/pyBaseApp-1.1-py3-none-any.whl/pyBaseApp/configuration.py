...
class Configuration:
    ...
    def __init__(self, loggerfolder='logs/', loggerlevel = logging.INFO):
        self.loggerfolder = loggerfolder
        self._defaultLogger(loggerlevel)
    ...
    def _defaultLogger(self, loggerlevel):
        ...
        console_handler.setLevel(loggerlevel)
        ...
        file_handler.setLevel(loggerlevel)
