...
htmlhelp_basename = 'mock_project'
...
latex_documents = [ #
    (master_doc, 'mock_project.tex', 'Mock Project',
     'Kale Kundert', 'manual'),
]
...
man_pages = [ #
    (master_doc, 'mock_project', 'Mock Project',
     [author], 1)
]
...
texinfo_documents = [ #
    (master_doc, 'mock_project', 'Mock Project',
     author, 'mock_project', 'One line description of project.',
     'Miscellaneous'),
]
