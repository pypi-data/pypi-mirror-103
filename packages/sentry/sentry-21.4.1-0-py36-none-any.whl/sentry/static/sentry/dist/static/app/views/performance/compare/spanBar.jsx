...
import { getBackgroundColor, getHatchPattern, getHumanDuration, toPercent, } from 'app/components/waterfallTree/utils';
...
var SpanBar = /** @class */ (function (_super) {
    ...
    SpanBar.prototype.renderSpanTreeToggler = function (_a) {
        ...
        <TreeToggle disabled={!!isRoot} isExpanded={this.props.showSpanTree} onClick={function (event) {
                event.stopPropagation();
                if (isRoot) {
                    return;
                }
