...
function AddWidget(_a) {
    var onClick = _a.onClick, orgFeatures = _a.orgFeatures, orgSlug = _a.orgSlug, dashboardId = _a.dashboardId;
    var _b = useSortable({
        disabled: true,
    ...
    return (<WidgetWrapper key="add" ref={setNodeRef} displayType={DisplayType.BIG_NUMBER} layoutId={ADD_WIDGET_BUTTON_DRAG_ID} style={{ originX: 0, originY: 0 }} animate={transform
      ...
      {orgFeatures.includes('metrics') ? (<InnerWrapper>
          <ButtonBar gap={1}>
            <Button to={"/organizations/" + orgSlug + "/dashboards/" + dashboardId + "/widget/new/?dataSet=metrics"}>
