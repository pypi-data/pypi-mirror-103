...
var UsageChart = /** @class */ (function (_super) {
    ...
    UsageChart.getDerivedStateFromProps = function (nextProps, prevState) {
        var usageDateStart = nextProps.usageDateStart, usageDateEnd = nextProps.usageDateEnd, usageDateInterval = nextProps.usageDateInterval;
        var xAxisDates = getXAxisDates(usageDateStart, usageDateEnd, usageDateInterval);
