...
function StatsRequest(_a) {
    var api = _a.api, organization = _a.organization, projectSlug = _a.projectSlug, queries = _a.queries, environments = _a.environments, datetime = _a.datetime, location = _a.location, children = _a.children, yAxis = _a.yAxis;
    ...
    function fetchData() {
        ...
        var promises = queriesWithAggregation.map(function (_a) {
            var aggregation = _a.aggregation, groupBy = _a.groupBy, tags = _a.tags;
            var query = __assign({ field: aggregation + "(" + yAxis + ")", interval: getInterval(datetime) }, requestExtraParams);
            if (tags) {
                var tagsWithDoubleQuotes = tags
                    .split(' ')
    ...
    function getChartData(sessionReponses) {
        ...
        var seriesData = sessionReponses.map(function (sessionResponse, index) {
            var _a = queries[index], aggregation = _a.aggregation, groupBy = _a.groupBy, legend = _a.legend;
            var field = aggregation + "(" + yAxis + ")";
            var breakDownChartData = getBreakdownChartData({
                response: sessionResponse,
                legend: !!legend ? legend : "Query " + (index + 1),
                groupBy: !!(groupBy === null || groupBy === void 0 ? void 0 : groupBy.length) ? groupBy[0] : undefined,
            });
            var chartData = fillChartDataFromSessionsResponse({
                response: sessionResponse,
                field: field,
                groupBy: !!(groupBy === null || groupBy === void 0 ? void 0 : groupBy.length) ? groupBy[0] : null,
