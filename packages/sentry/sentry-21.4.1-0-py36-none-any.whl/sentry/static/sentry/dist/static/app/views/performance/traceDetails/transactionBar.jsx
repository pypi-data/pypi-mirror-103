...
var TransactionBar = /** @class */ (function (_super) {
    ...
    TransactionBar.prototype.renderToggle = function () {
        ...
        <TreeToggle disabled={isRoot} isExpanded={isExpanded} onClick={function (event) {
    ...
    TransactionBar.prototype.render = function () {
        ...
        var showDetail = this.state.showDetail;
        return (<Row visible={isVisible} showBorder={showDetail} cursor={isTraceFullDetailed(transaction) ? 'pointer' : 'default'}>
