...
var Dashboard = /** @class */ (function (_super) {
    ...
    Dashboard.prototype.render = function () {
        var _this = this;
        var _a = this.props, isEditing = _a.isEditing, onUpdate = _a.onUpdate, widgets = _a.dashboard.widgets, organization = _a.organization, paramDashboardId = _a.paramDashboardId;
        ...
        <WidgetContainer>
          <SortableContext items={items} strategy={rectSortingStrategy}>
            ...
            {isEditing && (<AddWidget dashboardId={paramDashboardId} orgSlug={organization.slug} orgFeatures={organization.features} onClick={this.handleStartAdd}/>)}
          </SortableContext>
        </WidgetContainer>
      </DndContext>);
    };
