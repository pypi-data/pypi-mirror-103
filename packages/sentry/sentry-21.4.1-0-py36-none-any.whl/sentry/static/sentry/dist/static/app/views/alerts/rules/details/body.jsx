...
var DetailsBody = /** @class */ (function (_super) {
    ...
    DetailsBody.prototype.render = function () {
        var _this = this;
        var _a = this.props, api = _a.api, rule = _a.rule, incidents = _a.incidents, location = _a.location, organization = _a.organization, timePeriod = _a.timePeriod, selectedIncident = _a.selectedIncident, orgId = _a.params.orgId;
        if (!rule) {
        ...
        {function (_a) {
              ...
              <StyledLayoutBodyWrapper>
                <Layout.Main>
                  ...
                  <MetricChart api={api} rule={rule} incidents={incidents} timePeriod={timePeriod} selectedIncident={selectedIncident} organization={organization} projects={projects} metricText={_this.getMetricText()} interval={_this.getInterval()} filter={_this.getFilter()} query={queryWithTypeFilter} orgId={orgId}/>
                  <DetailWrapper>
                    <ActivityWrapper>
...
var HeaderGrid = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: auto auto auto;\n  align-items: start;\n  gap: ", ";\n"], ["\n  display: grid;\n  grid-template-columns: auto auto auto;\n  align-items: start;\n  gap: ", ";\n"])), space(4));
...
var StyledLayoutBodyWrapper = styled(Layout.Body)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  margin-bottom: -", ";\n"], ["\n  margin-bottom: -", ";\n"])), space(3));
var StyledAlert = styled(Alert)(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  margin: 0;\n"], ["\n  margin: 0;\n"])));
var ActivityWrapper = styled('div')(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  display: flex;\n  flex: 1;\n  flex-direction: column;\n  width: 100%;\n"], ["\n  display: flex;\n  flex: 1;\n  flex-direction: column;\n  width: 100%;\n"])));
...
var SidebarHeading = styled(SectionHeading)(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  display: grid;\n  grid-template-columns: auto auto;\n  justify-content: flex-start;\n  margin-top: ", ";\n  line-height: 1;\n  gap: ", ";\n"], ["\n  display: grid;\n  grid-template-columns: auto auto;\n  justify-content: flex-start;\n  margin-top: ", ";\n  line-height: 1;\n  gap: ", ";\n"])), function (p) { return (p.noMargin ? 0 : space(2)); }, space(1));
var ChartControls = styled('div')(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"], ["\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n"])));
var ChartPanel = styled(Panel)(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  margin-top: ", ";\n"], ["\n  margin-top: ", ";\n"])), space(2));
var RuleText = styled('div')(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  font-size: ", ";\n"], ["\n  font-size: ", ";\n"])), function (p) { return p.theme.fontSizeLarge; });
var Filters = styled('span')(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n  width: 100%;\n  overflow-wrap: break-word;\n  font-size: ", ";\n  gap: ", ";\n"], ["\n  width: 100%;\n  overflow-wrap: break-word;\n  font-size: ", ";\n  gap: ", ";\n"])), function (p) { return p.theme.fontSizeMedium; }, space(1));
var TriggerCondition = styled('div')(templateObject_16 || (templateObject_16 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n"], ["\n  display: flex;\n  align-items: center;\n"])));
var TriggerText = styled('div')(templateObject_17 || (templateObject_17 = __makeTemplateObject(["\n  margin-left: ", ";\n  white-space: nowrap;\n"], ["\n  margin-left: ", ";\n  white-space: nowrap;\n"])), space(1));
var CreatedBy = styled('div')(templateObject_18 || (templateObject_18 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), overflowEllipsis);
