...
var AlertRuleDetails = /** @class */ (function (_super) {
    ...
    AlertRuleDetails.prototype.render = function () {
        ...
        <Feature organization={organization} features={['alert-details-redesign']}>
          ...
          <DetailsBody {...this.props} rule={rule} incidents={incidents} timePeriod={timePeriod} selectedIncident={selectedIncident} handleTimePeriodChange={this.handleTimePeriodChange}/>
        </Feature>
      </React.Fragment>);
    };
