...
function Card(_a) {
    ...
    return (<ErrorBoundary customComponent={<ErrorCard>{t('Error loading widget data')}</ErrorCard>}>
      <StyledPanel>
        <Title>{title}</Title>
        <StatsRequest api={api} location={location} organization={organization} projectSlug={project.slug} yAxis={yAxis} queries={queries} environments={selection.environments} datetime={selection.datetime}>
          {function (_a) {
