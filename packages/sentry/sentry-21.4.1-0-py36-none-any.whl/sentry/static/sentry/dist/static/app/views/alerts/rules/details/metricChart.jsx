...
import { AlertRuleStatus, IncidentActivityType, IncidentStatus, } from '../../types';
...
function createIncidentSeries(router, orgSlug, lineColor, incidentTimestamp, incident, dataPoint, seriesName) {
    var series = {
            ...
            data: [
                {
                    ...
                    onClick: function () {
                        router.push({
                            pathname: "/organizations/" + orgSlug + "/alerts/rules/details/" + (incident.alertRule.status === AlertRuleStatus.SNAPSHOT &&
...
var MetricChart = /** @class */ (function (_super) {
    ...
    MetricChart.prototype.render = function () {
        var _this = this;
        var _a = this.props, api = _a.api, router = _a.router, rule = _a.rule, organization = _a.organization, timePeriod = _a.timePeriod, selectedIncident = _a.selectedIncident, projects = _a.projects, interval = _a.interval, metricText = _a.metricText, filter = _a.filter, query = _a.query, incidents = _a.incidents;
        if (!rule) {
        ...
        {function (_a) {
                ...
                if (incidents) {
                    ...
                    incidents
                        ...
                        series.push(createIncidentSeries(router, organization.slug, incidentColor, incidentStartDate, incident, incidentStartValue, series[0].seriesName));
...
var StyledPanelBody = styled(PanelBody)(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n  padding-right: 6px;\n"], ["\n  padding-right: 6px;\n"])));
var StatCount = styled('span')(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  margin-left: ", ";\n  margin-top: ", ";\n  color: ", ";\n"], ["\n  margin-left: ", ";\n  margin-top: ", ";\n  color: ", ";\n"])), space(0.5), space(0.25), function (p) { return p.theme.textColor; });
