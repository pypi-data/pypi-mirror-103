...
class SDKBase:
    ...
    """
    def __init__(self, sdk_configuration: SDKConfiguration, requests_session: aiohttp.ClientSession) -> None:
        self.sdk_configuration: SDKConfiguration = sdk_configuration
        self.requests_session: aiohttp.ClientSession = requests_session
