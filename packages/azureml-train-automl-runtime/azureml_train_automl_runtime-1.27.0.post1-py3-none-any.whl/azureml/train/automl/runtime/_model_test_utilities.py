...
def _save_results(results, run):
    ...
    with tempfile.TemporaryDirectory() as project_folder:
        ...
        # Use the default workpaceblobstore as the location for
        # storing the users predictions.csv output file(s) so that
        # the UI can directly link to the file for users to download.
        # Some of the other datastores do not support having a direct
        # download url.
