...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', '2.1.0-alpha.1619458606+8d3bef68'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas 2.1.0-alpha.1619458606+8d3bef68`
                """)
            else:
                raise
