...
class OHCLV(object):
    ...
    def __init__(self, close=None, high=None, end_date=None, open=None, time=None, volume=None, usd_volume=None, btc_volume=None, quote_volume=None, _configuration=None):  # noqa: E501
