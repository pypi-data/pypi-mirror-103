...
class _SQLColumnExpression(_LogicalColumnExpression,
    ...
    def window(self,
        ...
        """
        DESCRIPTION:
            Generates Window object on a teradataml DataFrame Column to run
        ...
        PARAMETERS:
            partition_columns:
                ...
                Note:
                    ...
                    from teradataml DataFrame column, constitutes a single
        ...
        EXAMPLES:
            ...
            # TODO: Examples for executing aggregate functions on a column in teradataml DataFrame.
        """
