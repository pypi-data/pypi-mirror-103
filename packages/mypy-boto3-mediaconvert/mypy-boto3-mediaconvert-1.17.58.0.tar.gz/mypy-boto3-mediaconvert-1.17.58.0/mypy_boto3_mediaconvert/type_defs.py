...
Ac3SettingsTypeDef = TypedDict(
    "Ac3SettingsTypeDef",
    {
        ...
        "DynamicRangeCompressionLine": Literal[
            "FILM_STANDARD", "FILM_LIGHT", "MUSIC_STANDARD", "MUSIC_LIGHT", "SPEECH", "NONE"
        ],
...
CmafGroupSettingsTypeDef = TypedDict(
    "CmafGroupSettingsTypeDef",
    {
        ...
        "PtsOffsetHandlingForBFrames": Literal["ZERO_BASED", "MATCH_INITIAL_PTS"],
...
CmfcSettingsTypeDef = TypedDict(
    "CmfcSettingsTypeDef",
    {
        ...
        "DescriptiveVideoServiceFlag": Literal["DONT_FLAG", "FLAG"],
...
DashIsoGroupSettingsTypeDef = TypedDict(
    "DashIsoGroupSettingsTypeDef",
    {
        ...
        "AudioChannelConfigSchemeIdUri": Literal[
