...
def _each_run_file_rotate_handler(in_file_name, in_back_up):
    ...
    formatter = CustomFormatter(fmt='{asctime}.{msecs} |{levelname:^11}|{threadName:^12}|{lineno:^5}| {name:<50} |{funcName:^30}||--> {message}', datefmt=_date_format, style='{')
