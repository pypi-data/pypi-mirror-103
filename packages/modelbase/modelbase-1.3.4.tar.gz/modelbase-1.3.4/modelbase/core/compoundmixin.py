...
class CompoundMixin:
    ...
    def add_compound(
        ...
        **meta_info,
        ...
        if compound == "time":
            ...
            self._check_and_insert_ids([compound])

    def add_compounds(self, compounds: list[str], meta_info=None):
    ...
    def update_compound_meta_info(self, compound: str, meta_info: dict):
    ...
    def remove_compound(self, compound: str):
    ...
    def remove_compounds(self, compounds: list[str]):
        for compound in compounds:
            self.remove_compound(compound=compound)
    ...
    def _generate_compounds_source_code(self, *, include_meta_info=True) -> str:
