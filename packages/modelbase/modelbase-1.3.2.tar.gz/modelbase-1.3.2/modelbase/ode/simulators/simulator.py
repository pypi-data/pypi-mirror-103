...
class _Simulate(_BaseSimulator):
    ...
    def __reduce__(self) -> tuple[list[float], list[float], list[np.ndarray], list[dict[str, float]]]:
        """Pickle this class."""
        return (
            self.__class__,
            (
    ...
    def update_parameter(self, parameter_name: str, parameter_value: float):
    ...
    def _save_simulation_results(self, *, time: np.ndarray, results: np.ndarray, skipfirst: bool):
