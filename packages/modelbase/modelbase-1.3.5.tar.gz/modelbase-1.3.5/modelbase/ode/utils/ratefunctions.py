...
def mass_action_variable(*args: tuple[float]) -> float:
...
def reversible_mass_action_variable_1(*args: tuple[float]) -> float:
...
def reversible_mass_action_variable_2(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_3(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_4(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_5(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_6(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_7(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_mass_action_variable_8(*args: tuple[float]) -> float:
    *metabolites, k_fwd, k_bwd = args
...
def reversible_uncompetitive_inhibition_keq(
    S: float, P, I: float, vmax_fwd, kms: float, kmp, ki: float, keq
) -> float:
    return vmax_fwd / kms * (S - P / keq) / (1 + (S / kms) + (P / kmp) * (1 + I / ki))


def reversible_noncompetitive_inhibition_keq(
    S: float, P, I: float, vmax_fwd: float, kms: float, kmp: float, ki: float, keq: float
) -> float:
    return vmax_fwd / kms * (S - P / keq) / ((1 + S / kms + P / kmp) * (1 + I / ki))
