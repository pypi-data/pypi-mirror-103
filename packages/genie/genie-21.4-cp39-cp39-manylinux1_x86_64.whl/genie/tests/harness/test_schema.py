...
@aetest.subsection
def test_subsection(self, testbed, testscript, param1, param2):
    pass

@aetest.subsection
def test_subsection_without_params(self):
    pass
...
class TestSchemaEngine(unittest.TestCase):
    ...
    def test_subsection_data_file_schema(self):
        ...
        setup:
            sections:
              my_own_common_setup:
                method: genie.harness.datafile.tests.test_schema.test_subsection
                parameters:
                  param1 : a
                  param2 : b
