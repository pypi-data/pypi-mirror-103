...
class TradeUpdate:
    ...
    def _save(self):
        self.tradeDB._save()
        self.kline_1min._save()
        self.kline_5min._save()
        self.kline_15min._save()
        self.kline_30min._save()
        self.kline_4hour._save()
        self.kline_1day._save()
        self.kline_1mon._save()
        self.kline_1week._save()
        self.kline_1year._save()
