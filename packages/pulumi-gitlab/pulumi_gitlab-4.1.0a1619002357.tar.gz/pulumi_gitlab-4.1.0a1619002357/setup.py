...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', '4.1.0-alpha.1619002357+111931d0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab 4.1.0-alpha.1619002357+111931d0`
                """)
            else:
                raise
