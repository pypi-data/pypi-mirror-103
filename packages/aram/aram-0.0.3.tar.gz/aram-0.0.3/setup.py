...
setuptools.setup(
    include_package_data=True,       # Good stuff
    ...
    py_modules=["aram",'aram_tools'],             # Name of the python package
    package_dir={'':'aram/src'},     # Directory of the source code of the package
    install_requires=['numpy','scipy','ephem','gc','pickle']                     # Install other dependencies if any
)
