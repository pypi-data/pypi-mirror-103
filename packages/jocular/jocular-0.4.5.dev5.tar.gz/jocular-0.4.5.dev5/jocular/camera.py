...
class AscomCamera(GenericCamera):
    ...
    def connect(self):
        ...
        try:
            ...
            self._camera = win32com.client.Dispatch(driver)
    ...
    def capture_sub(self, exposure=None, on_capture=None, on_failure=None,
        ...
        if is_bias:
            self.exposure = .001
        self._camera.startExposure(self.exposure, True) # second arg means open shutter 
        ...
        if return_image:
            ...
            return np.array(self._camera.ImageArray)
...
# im16 = image.astype(np.uint16)
# hdu = fits.PrimaryHDU(im16)
# hdu.writeto('test16.fits')
