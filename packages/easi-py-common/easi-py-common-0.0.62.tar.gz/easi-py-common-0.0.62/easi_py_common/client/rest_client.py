...
class RestClient:
    ...
    def get(self, uri, params=None, timeout=None, dst=None, **kwargs):
        ...
        return self._do_response(resp, _url, None, params, timeout, kwargs, dst)
    ...
    def post(self, uri, json_data=None, params=None, timeout=None, dst=None, request_by_alias: bool = True, **kwargs):
        ...
        return self._do_response(resp, _url, json_data, params, timeout, kwargs, dst)
    ...
    def _do_response(self, resp, url, json_data, params, timeout, other_kwargs, dst):
