...
class EnergyPlotting:
    ...
    COLORS_DICT: dict = {GRID: Plotting.Color.BROWN, TRANSFORMER: Plotting.Color.YELLOW,
                         AUXILIARY: Plotting.Color.BLUE,
                         ACDC_CONVERTER: Plotting.Color.CYAN, DCDC_CONVERTER: Plotting.Color.VIOLET,
                         STORAGE_TECHNOLOGY: Plotting.Color.BRIGHT_GREEN,
                         LOSSES: Plotting.Color.RED, LINKS: Plotting.Color.GREY}
    ...
    def create_categories(self):
        ...
        :return: Node/category labels for charge/discharge, and losses as dicta
        """
        # Current implementation represents one StorageSystemAC with one Sankey diagram
        ...
        if ac_system_id == 0:
            ...
            while dc_idx <= number_dc_systems:
                ...
                dcdc_converters += dc_system_id_str + self.__system_parameters_reader.get_dcdc_converter_type_for(
                    ac_system_id, dc_idx) + ' '
