...
class SimSES(threading.Thread):
    ...
    __VERSION_FILE: str = 'VERSION'
    __GIT_FILE: str = '../.git/FETCH_HEAD'
    ...
    def __init__(self, path: str, name: str, do_simulation: bool = True, do_analysis: bool = True,
        ...
        if self.__do_analysis:
            self.__storage_analysis: StorageAnalysis = StorageAnalysis(path, analysis_config, batch_dir, self.version)
