...
class DaimlerLMO(CellType):
    ...
    def __init__(self, voltage: float, capacity: float, soh: float, battery_config: BatteryConfig,
        ...
        # capacity_cyc = pd.read_csv(capacity_cyc_file, delimiter=';', decimal=",")  # -
        ...
        # ri_cyc = pd.read_csv(ri_cyc_file, delimiter=';', decimal=",")  # -
        ...
        # capacity_cal = pd.read_csv(capacity_cal_file, delimiter=';', decimal=",")  # -
        ...
        # ri_cal = pd.read_csv(ri_cal_file, delimiter=';', decimal=",")  # -
