...
class HighPerformanceStack5700W(StackModule):
    ...
    def __init__(self, electrolyte_system: ElectrolyteSystem, voltage: float, power: float,
        ...
        self.__internal_resistance = pd.read_csv(self.__RINT_FILE, delimiter=';', decimal=",", header=None)  # Ohm
        ...
        self.__self_discharge_current = pd.read_csv(self.__SD_FILE, delimiter=';', decimal=",", header=None)  # mA/cm^2
