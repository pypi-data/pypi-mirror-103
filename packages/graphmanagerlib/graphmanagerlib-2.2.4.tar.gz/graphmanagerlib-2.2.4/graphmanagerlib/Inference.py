...
def predictionsUnique(saved_model_folder, document_to_predict_json,labels_tab):
    getDataForUniquePrediction(document_to_predict_json, saved_model_folder)

    predictions_data = load_predictionData(save_fd=saved_model_folder)
