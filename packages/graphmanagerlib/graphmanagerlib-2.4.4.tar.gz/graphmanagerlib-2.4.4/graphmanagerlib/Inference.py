...
def predictionsUnique(saved_model_folder,saved_prediction_dataset_folder,json,labels_tab):
    getDataForUniquePrediction(json,saved_prediction_dataset_folder)
