...
def on_init(ctx):
    ...
    ctx.subscribe(('cu2106.SHFE','1m'),('rb2110.SHFE','1m'),('fu2109.SHFE','1m'),('ss2106.SHFE','1m'))

    ctx.subscribe(('IH2105.CFFEX','1m'),('IC2105.CFFEX','1m'))

    ctx.subscribe(('m2109.DCE','1m'),('p2109.DCE','1m'))

    ctx.subscribe(('AP109.CZCE','1m'),('CJ109.CZCE','1m'))

    ctx.subscribe(('bc2106.INE','1m'),('sc2106.INE','1m'))
