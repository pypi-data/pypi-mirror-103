...
class Message:
    ...
    def from_json(json):
        return Message(json["sender"], json["content"], json["channel"], Attachment.from_json(json["attachment"]), json["called"])
    ...
    def to_json(self):
        return {"sender":self.sender, "content":self.content, "channel":self.channel, "called":self.called, "attachment":self.attachment.to_json() if self.attachment is not None else None}
