...
with open(os.path.join('hiddenfigures', 'analysis', 'PROTOBUF_VERSION'), 'r') as f:
    PROTOBUF_VERSION = json.loads(f.read())


with open(os.path.join('HIDDEN_FIGURES_VERSION'), 'r') as f:
...
setup(
    ...
    url='https://github.com/millcityrunner/hiddenfigures',
    ...
    entry_points={
        'console_scripts': ['hiddenfigures=hiddenfigures.command_line:main']
    }
)
