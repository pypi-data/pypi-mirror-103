...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '4.1.0-alpha.1619003083+2a8c2b6c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 4.1.0-alpha.1619003083+2a8c2b6c`
                """)
            else:
                raise
