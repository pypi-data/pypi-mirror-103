...
atoms3.set_constraint(FixAtoms(mask=atoms3.get_tags()))
...
atoms5.set_constraint(FixAtoms(mask=atoms5.get_tags()))
...
atoms6.set_constraint(FixAtoms(mask=atoms6.get_tags()))
...
atoms7.set_constraint(FixAtoms(mask=atoms7.get_tags()))
