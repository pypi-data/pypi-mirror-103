...
class FECNNLayer(Layer):
    ...
    def build(self, input_shape):
        ...
        for i in range(1, len(self.filters) + 1): 
            ...
            if width[1]!=1:
                pooling_shape = self._pooling_output_shape(conv_output_shape, (pooling_width, pooling_width)) 
            else:
            ...
            if width[1]!=1:
                self.pooling_layers.append(tf.keras.layers.MaxPooling2D(pool_size=(pooling_width, pooling_width)))
            else:
