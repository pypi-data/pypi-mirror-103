.. cf-crypt documentation master file, created by
   sphinx-quickstart on Sat Apr  3 21:16:28 2021.
...
There are a bunch of other useful encryption related tools in the module.

 * :ref:`String encryption <rsahighlevelstring>`
 * :ref:`Python object serialization + encryption <rsahighlevelobject>`
 * :ref:`RSA signing & verification <rsalowlevelsign>`
 * :ref:`File & folder encryption <fileutils>`
 * :ref:`Key management <keyring>`
