...
class KubernetesJobOperator(KubernetesJobOperatorDefaultsBase):
    ...
    def __init__(
        ...
        delete_policy: Union[str,
                             JobRunnerDeletePolicy] = DEFAULT_DELETE_POLICY,
        in_cluster: bool = None,
        config_file: str = None,
        get_logs: bool = True,
        cluster_context: str = None,
        startup_timeout_seconds: float = DEFAULT_TASK_STARTUP_TIMEOUT,
        execution_timeout_seconds: float = DEFAULT_TASK_EXECUTION_TIMEOUT,
        ...
        **kwargs,
        ...
        Keyword Arguments:
            ...
            startup_timeout_seconds {int} -- The max number of seconds to create the job before timeout is called.
            execution_timeout_seconds {int} -- The max number of seconds for the job to finish before abort is called.
    ...
    def execute(self, context):
        ...
        try:
            rslt = self.job_runner.execute_job(
                watcher_start_timeout=int(self.startup_timeout_seconds),
                timeout=int(self.execution_timeout_seconds),
            )
    ...
    def on_kill(self):
        ...
        if self._job_is_executing:
            ...
            try:
                ...
                self.log.error("Failed to delete an aborted/killed" +
