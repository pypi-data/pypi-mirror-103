...
class ChopModelMap:
    ...
    def set_env(self, work_dir,
        ...
        tmp_log_path = os.path.join(self.tmp_log_dir, '{}{}{}'.format('rank_', self.rank, '.process_log'))
    ...
    def chop_model_map_parallel(self, residue_list, chop_map=True, chopping_mode='soft',
        ...
        if self.rank == 0:
            ...
            # Add workers logs to the master process_log
    ...
    def format_statistics(statistics_dict):
        """
        Formats the chopping statistics for the process_log output
...
def main():
    ...
    log_path = os.path.join(chop_dir, 'chop_' + name + '.process_log')
