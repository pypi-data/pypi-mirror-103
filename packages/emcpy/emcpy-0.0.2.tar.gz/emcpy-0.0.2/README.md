...
### Townless
#### A list of all the townless players
```python
from emcpy import Townless

townless = Townless()

# Get the attributes
# For player in townless list
nickname = townless.nick # Nickname of the player
name = townless.name # Name
isUnderGround = townless.isUnderground # Is the player visible on the map
coords = townless.coords # Dict of {'x', 'y', 'z'}. If isUnderground is True, coords = 0, 64, 0
```
...
## Useful methods
```python
from methods import getAllOnline, getAllTowns, getAllResidents, getAllNations
...
## Credits
### Credits to Warriorrrr and Owen77Stubbs