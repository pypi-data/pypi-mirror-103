...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.1.0-alpha.1619000604+fb440e6f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.1.0-alpha.1619000604+fb440e6f`
                """)
            else:
                raise
