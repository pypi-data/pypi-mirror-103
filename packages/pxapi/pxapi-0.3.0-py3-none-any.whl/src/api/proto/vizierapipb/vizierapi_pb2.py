...
_QUERYDATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='execution_stats', full_name='px.api.vizierpb.QueryData.execution_stats', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
UInt128 = _reflection.GeneratedProtocolMessageType('UInt128', (_message.Message,), {
  'DESCRIPTOR' : _UINT128,
  '__module__' : 'src.api.proto.vizierapipb.vizierapi_pb2'
