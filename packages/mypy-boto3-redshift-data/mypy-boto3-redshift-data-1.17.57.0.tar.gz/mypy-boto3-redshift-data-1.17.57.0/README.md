...
[boto3.RedshiftDataAPIService 1.17.57](https://boto3.amazonaws.com/v1/documentation/api/1.17.57/reference/services/redshift-data.html#RedshiftDataAPIService) service
compatible with
