...
###from PyPDM.Util_module.Utils import Util
...
def Test_3D_sclr(Diff_Ops, gc, nodeTagsMinusOne4K, Normals, dim, fout=None, usingSparseMat=True):
    ...
    #c = 1; dx = 2; dy = 3; dz = 4; d2x = 5; dxdy = 6; dxdz = 7;
    ...
    for i_node in range(0,n_node):
        if var_type[i_node][0] == 0:
            ...
            if (usingSparseMat):  # using sparse matrix
                ...
                K_glb[i_node,:] =  (Diff_Ops[i_node][d2x,:] + Diff_Ops[i_node][d2y,:] + Diff_Ops[i_node][d2z,:]).todense()
            ...
            if (usingSparseMat):  # using sparse matrix
                ...
                K_glb[i_node,:] = (Diff_Ops[i_node][c,:]).todense()
            ...
            if (usingSparseMat):  # using sparse matrix
                ...
                K_glb[i_node,:] = (Diff_Ops[i_node][dx,:]*Normals[i_node][0] + Diff_Ops[i_node][dy,:]*Normals[i_node][1] + Diff_Ops[i_node][dz,:]*Normals[i_node][2]).todense()
